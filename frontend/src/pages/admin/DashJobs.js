...
import { createJobAction, deleteJobAction, jobLoadAction } from '../../redux/actions/jobAction';
    ...
    return (
        <Box >
            ...
            <Box sx={{ pb: 2, display: "flex", justifyContent: "right" }}>
                <Button onClick={(e) => createAJob(e)} variant='contained' color="success" startIcon={<AddIcon />}> <Link style={{ color: "white", textDecoration: "none" }} to="/admin/job/create">Create Job</Link></Button>
            </Box>
